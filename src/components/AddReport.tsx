      ...
      {pre === false ? (
          ...
          {({ errors, touched, isValidating }) => (
            <Container style={{ padding: 30 }}>
              <Form>
                ...
                {errors.soyadi && touched.soyadi ? (
                  <div>{errors.soyadi}</div>
                ) : null}
                ...
                {errors.darpDurumu && touched.darpDurumu ? (
                  <div>{errors.darpDurumu}</div>
                ) : null}
                ...
                {next ? (
                  <>
                    ...
                    <Field
                      ...
                      component={SelectPicker}
                    />
                    {errors.gelisNedeni && touched.gelisNedeni ? (
                      <div>{errors.gelisNedeni}</div>
                    ) : null}
                    <br />
                    <label htmlFor="gelisNedeniAciklama">
                    ...
                    <Field id="sikayet" name="sikayet" component={Input} />
                    {errors.sikayet && touched.sikayet ? (
                      <div>{errors.sikayet}</div>
                    ) : null}
                    <label htmlFor="uygunOrtamSaglandi">
                      {" "}
                    ...
                    <Field
                      ...
                      component={Toggle}
                    />
                    {errors.uygunOrtamSaglandi && touched.uygunOrtamSaglandi ? (
                      <div>{errors.uygunOrtamSaglandi}</div>
                    ) : null}
                    <br />
                    ...
                    <Field
                      ...
                      component={TagPicker}
                    />
                    {errors.odadaBulunanlar && touched.odadaBulunanlar ? (
                      <div>Odada bulunanlar kısmı boş bırakılamaz</div>
                    ) : null}
                    <br />
                    <label htmlFor="doktorAdi">Doktor adı</label>
                    <Field id="doktorAdi" name="doktorAdi" component={Input} />
                    {errors.doktorAdi && touched.doktorAdi ? (
                      <div>{errors.doktorAdi}</div>
                    ) : null}
                    ...
                    <Field
                      ...
                      component={Input}
                    />
                    {errors.organizasyon && touched.organizasyon ? (
                      <div>{errors.organizasyon}</div>
                    ) : null}
                    <Button type="submit">Önizleme</Button>
                  </>
                ) : null}
              </Form>
            </Container>
        ...
        <Container>
          <>
            ...
            <Button appearance="primary">Formu kaydet</Button>
          </>
        </Container>
      )}
    </div>
